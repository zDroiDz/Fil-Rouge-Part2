...
public class ControlRequeteRecherche {
	...
	/**
	 * Instantiates a new control requete recherche.
	 *
	 * @param recherche the recherche
	 */
	public ControlRequeteRecherche(String recherche) {
	...
	public ControlRequeteRecherche(String requeteRecherche, String utilisateurRecherche, String typeRecherche, Map<String,String> mapResultat) {
